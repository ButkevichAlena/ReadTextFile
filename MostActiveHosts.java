...
public class MostActiveHosts implements IMostActiveHosts<ReportForMostActiveHosts> {
	
	@Override
	public ReportForMostActiveHosts mostActive(ArrayList<Line> list, Date firstDate, Date secondDate){
